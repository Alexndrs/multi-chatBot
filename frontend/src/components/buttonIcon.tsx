...
const variantClasses = {
    primary: "py-2 px-3 bg-[var(--color-CTA)]/80 hover:bg-[var(--color-CTA)] border-[var(--color-CTA)] text-gray-800 cursor-pointer",
    ...
    deactivated: "py-2 px-3 bg-gray-800 border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-gray-500 cursor-not-allowed",
};
